...
We actively support the following versions of `botview` with security updates:
...
We take the security of `botview` seriously. If you discover a security vulnerability, please follow these steps:

### How to Report

1. **DO NOT** open a public GitHub issue for security vulnerabilities
2. Send a detailed report to the repository maintainer via:
   - GitHub Security Advisory: [Report a vulnerability](https://github.com/MobileTeleSystems/botview/security/advisories/new)
   - Email: Create an issue in the [issue tracker](https://github.com/MobileTeleSystems/botview/issues) marked as **Security** (if no sensitive details need to be shared)
...
- **Version**: The version of `botview` affected
- **Environment**: Relevant environment details (Node.js version, Playwright version, Docker version, etc.)
...
As a web page prerendering microservice, `botview`:

- **Accepts URLs as input** - all URLs are validated and requests are controlled
- **Renders external content** - uses isolated browser context for security
- **Does not store data** - renders are performed on-demand
...
- Open a [GitHub Security Advisory](https://github.com/MobileTeleSystems/botview/security/advisories/new)
- Create an issue at: <https://github.com/MobileTeleSystems/botview/issues>

---

Thank you for helping keep `botview` and its users safe!
